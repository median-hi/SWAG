...
public class ResetDiceLevelToConstantTest {
    ...
    class ActualGranIsConstant {
        ...
        public Set<Operation> initOperations() {
            Operation op3 = new Operation(ResetDiceLevelToConstant.getInstance(),
    ...
    @Nested
    @DisplayName("When actual dice level is constant and the same as te new dice level to set to")
    ...
    @Nested
    @DisplayName("When actual dice level is pair")
