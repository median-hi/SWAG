...
public class RollUpTest {
    ...
    @Nested
    @DisplayName("When actual granularity is constant and not top")
    class ActualGranIsConstantAndNotTop {
    ...
    @Nested
    @DisplayName("When actual granularity is constant and top")
    class ActualGranIsConstantAndTop {
    ...
    @Nested
    @DisplayName("When actual granularity is bound pair and not top")
    class ActualGranIsBoundParAndNotTop {
    ...
    @Nested
    @DisplayName("When actual granularity is bound pair and top")
    class ActualGranIsBoundParAndTop {
    ...
    @Nested
    @DisplayName("When actual granularity is unbound pair and not top")
    class ActualGranIsUnBoundParAndNotTop {
