...
public class RollUpToTest {
    ...
    @Nested
    @DisplayName("When actual granularity is constant and rollable to the parameter")
    class ActualGranIsConstantAndRollable {
        ...
        public Set<Operation> initOperations() {
            Operation op3 = new Operation(RollUpTo.getInstance(),
    ...
    @Nested
    @DisplayName("When actual granularity is constant not rollable to the parameter")
    class ActualGranIsConstantAndNotRollable {

        @Test
        @DisplayName("When actual granularity is constant and not rollable to the parameter")
        void added1() {
            source = createSource();
            target = createSource();
            ops = initOperations();
    ...
    @Nested
    @DisplayName("When actual granularity is bound pair and rollable to the parameter")
    ...
    @Nested
    @DisplayName("When actual granularity is bound pair and rollable")
    class ActualGranIsBoundParAndNotRollable {
    ...
    class ActualGranIsUnBoundParAndNotBottom {
        ...
        public Set<Operation> initOperations() {
            Operation op3 = new Operation(RollUpTo.getInstance(),
                    List.of(AppConstants.DESTINATION_DIM, AppConstants.TOP_DESTINATION_DIM));
            return Set.of(op3);
        }
