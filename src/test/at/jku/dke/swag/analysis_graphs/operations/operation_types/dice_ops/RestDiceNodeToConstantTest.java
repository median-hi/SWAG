...
public class RestDiceNodeToConstantTest {
    ...
    class ActualNodeIsConstant {
        ...
        public Set<Operation> initOperations() {
            Operation op3 = new Operation(ResetDiceNodeToConstant.getInstance(),
    ...
    @Nested
    @DisplayName("When actual dice node is constant and dice level is a bound pair")
    class ActualNodeIsConstantAndLevelBound {
    ...
    @Nested
    @DisplayName("When actual dice node is a bound value of a parameter and dice level is bound parameter")
