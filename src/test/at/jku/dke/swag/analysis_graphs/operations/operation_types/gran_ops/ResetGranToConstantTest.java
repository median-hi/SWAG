...
public class ResetGranToConstantTest {
    ...
    class ActualGranIsConstant {
        ...
        public Set<Operation> initOperations() {
            Operation op3 = new Operation(ResetGranularityToConstant.getInstance(),
    ...
    @Nested
    @DisplayName("When actual granularity is constant and the same as te new granularity to set to")
    class ActualGranIsConstantAndEqualNewGran {
    ...
    @Nested
    @DisplayName("When actual granularity is pair")
